...
let düzbucaqlı2 = prompt("Düzbucaqlının uz");
...
let təqaüd = prompt("Sizin ölkədə pensiyaya çıxmaq yaşı neçədir?");
...
let İmtahan = prompt("Kimya dilindən neçə bal almısınız?")
let İmtahan2 = prompt("Riyaziyyatdan neçə bal almısınız?")
let İmtahan3 = prompt("Alman dilindən neçə bal almısınız?")
